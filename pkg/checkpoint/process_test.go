...
func TestProcess(t *testing.T) {
	...
	cases := []testCase{
		...
		{
			desc:              "Active checkpoint and no api parent: should stop",
			activeCheckpoints: map[string]*v1.Pod{"AA": {}},
			apiParents:        map[string]*v1.Pod{"BB": {}},
			expectGraceStop:   []string{"AA"},
		},
		{
		...
		{
			desc:              "Active checkpoint with local parent, and no api parent: should stop",
			activeCheckpoints: map[string]*v1.Pod{"AA": {}},
			localParents:      map[string]*v1.Pod{"AA": {}},
			apiParents:        map[string]*v1.Pod{"BB": {}},
			expectGraceStop:   []string{"AA"},
		...
		{
			desc:                "Both active and inactive checkpoints, with no api parent: stop both",
			activeCheckpoints:   map[string]*v1.Pod{"AA": {}},
			inactiveCheckpoints: map[string]*v1.Pod{"AA": {}},
			apiParents:          map[string]*v1.Pod{"BB": {}},
			expectGraceStop:     []string{"AA"}, // Only need single stop, we should clean up both active/inactive
		},
		{
		...
		{
			desc:         "Inactive pod-checkpointer, no local parent, no api parent: should stop in the last",
			...
			expectGraceStop: []string{"AA", "BB", "kube-system/pod-checkpointer"},
		},
		{
			desc:         "Inactive pod-checkpointer, no local parent, no api parent: should stop all",
			...
			expectStart:     []string{"kube-system/pod-checkpointer"},
			expectGraceStop: []string{"AA", "kube-system/pod-checkpointer"},
		},
		{
			desc:         "Active pod-checkpointer, no local parent, no api parent: should stop all",
			localRunning: map[string]*v1.Pod{"kube-system/pod-checkpointer": {}, "AA": {}},
			localParents: map[string]*v1.Pod{"AA": {}},
			apiParents:   map[string]*v1.Pod{"AA": {}},
			activeCheckpoints: map[string]*v1.Pod{
		...
		{
			desc:         "Running as an on-disk checkpointer: Inactive pod-checkpointer, no local parent, no api parent: should stop in the last",
			podName:      "pod-checkpointer-mynode",
			localRunning: map[string]*v1.Pod{"kube-system/pod-checkpointer": {}, "AA": {}},
			localParents: map[string]*v1.Pod{"BB": {}},
			apiParents:   map[string]*v1.Pod{"BB": {}},
		...
		{
			desc:         "Running as an on-disk checkpointer: Inactive pod-checkpointer, no local parent, no api parent: should stop all",
			podName:      "pod-checkpointer-mynode",
			localRunning: map[string]*v1.Pod{"kube-system/pod-checkpointer": {}, "AA": {}},
			localParents: map[string]*v1.Pod{"AA": {}},
			apiParents:   map[string]*v1.Pod{"AA": {}},
		...
		{
			desc:         "Running as an on-disk checkpointer: Active pod-checkpointer, no local parent, no api parent: should stop all",
			podName:      "pod-checkpointer-mynode",
			localRunning: map[string]*v1.Pod{"kube-system/pod-checkpointer": {}, "AA": {}},
			localParents: map[string]*v1.Pod{"AA": {}},
			apiParents:   map[string]*v1.Pod{"AA": {}},
